...
class HomeShiftScreen extends StatefulWidget {
  final UserModel userModel;
  const HomeShiftScreen({super.key, required this.userModel});

  @override
  State<HomeShiftScreen> createState() => _HomeShiftScreenState();
}

class _HomeShiftScreenState extends State<HomeShiftScreen> {
  //File? image;
